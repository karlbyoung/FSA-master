CREATE OR REPLACE TABLE DEV.${FSA_CURRENT_SCHEMA}.FSA_BOOMI_TEST AS
  ...
  (
    SELECT distinct o.SO_ORDER_NUMBER,o.so_customer_id 
      FROM DEV.${FSA_CURRENT_SCHEMA}.V_SO_MASTER o
      JOIN DEV.${FSA_CURRENT_SCHEMA}.FSA f
