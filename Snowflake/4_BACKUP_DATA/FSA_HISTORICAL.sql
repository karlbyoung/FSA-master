INSERT INTO DEV.${vj_fsa_schema}.FSA_HISTORICAL
  SELECT 
    PO_ID, 
    FSA_LOAD_STATUS, 
    ID, 
...
/*
--    20231109 - KBY, RFS23-3534 Include FSA_RELEASE_DATE
--    Expand FSA_HISTORICAL to include FSA_RELEASE_DATE
CREATE OR REPLACE TABLE DEV.NETSUITE2_FSA.FSA_HISTORICAL_NEW AS
SELECT 
    PO_ID, 
    FSA_LOAD_STATUS, 
    ID, 
